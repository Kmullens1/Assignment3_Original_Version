...
public class Ex42 {
    public static void main(String[] args) {
        ...
        down and turn into records so you can process them. CSV, or comma-separated
        ...
        Process the records and display the results formatted as a table, evenly spaced, as shown in theexample output.
        Example Output
            Last First Salary
            --------------------------
            Ling Mai 55900
